...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile overlay — rendered outside <nav> because the nav's transform/backdrop-filter
          would otherwise become the containing block for this fixed element and clip it. */}
      {mobileOpen && (
        <div
          role="dialog"
          aria-modal="true"
          className="md:hidden fixed inset-0 bg-blue-dark z-[60] flex flex-col items-center justify-center gap-10"
        >
          <button
